  ...
  <v-container class="pa-2">
    ...
    <v-row dense no-gutters>
      ...
      <v-col cols="12" md='12' v-else>
        <apexchart type="line" width='100%' height="300" :options="chartOptionsDate" :series="DewellSeriesDate"></apexchart>
      </v-col>
    </v-row>
  </v-container>
</template>
...
export default {
  ...
  computed: {
    ...
    DewellSeries () {
      var response = this.$store.state.stateGetDewellChart
      var series = []
    ...
    DewellSeriesDate () {
      ...
      series.splice(-1, 1)
      // console.log('stateGetDewellChart=====>', series)
      return series
    }
  },
  methods: {
